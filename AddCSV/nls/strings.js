define({
  root: ({
    _widgetLabel : "AddCSV",
    //description : "Drag and drop your CSV file directly into this panel for upload, must have lat/long coordinates in table.",
    selectCSV : "Select a CSV",
    loadingCSV : "Loading CSV",
    savingCSV: "CSVExport",
    clearResults : "Clear",
    downloadResults : "why are you here?? download",
    plotOnly : "Only Plot Points",
    plottingRows : "Plotting CSV rows",
    ...
    error : {
      ...
      CSVmissingRecords: 'The CSV file has missing data/cells.'
    },
    results : {
