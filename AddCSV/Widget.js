...
//NOTES...SB added CSV lat/long abilities 7/25/16
//Modified by MJM on 4/17/2017 to add CSV geocoding - see test files: \\Geobase-win\CED\GADS\R2017\R122\geocode
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  return declare([BaseWidget, _WidgetsInTemplateMixin], {
    ...
    _csvReadComplete : function(items) {
      if (items.length <= parseInt(this.config.maxRowCount, 10)) {
        ...
        var errorCnt = 0;
        this.errorList = [];
        this.enrichErrors.innerHTML = ""; //MJM - clear any old error messages
        this.enrichErrorsList.innerHTML = ""; //MJM - clear any old error messages
        ...
        array.forEach(items, function(item, i) {
          ...
          if (!errorFlag) {
            ...
            featureCollection.featureSet.features.push(feature);
               ...
               errorFlag = true;
	              errorCnt = errorCnt + 1;
	               //increase error id by 2 to handle zero start and 1 is the header.
	              this.errorList.push((parseInt(item._csvId, 10) + 2) + " - " + attributes.Address);
	              this.enrichErrors.innerHTML = "Error(s)";
           } //MJM----------------------------------------------
        ...
        this._showErrorAddressTable; //MJM - show address errors
    ...
    getAddressGeometry: function(address) {
      ...
      url1 = "https://gis.cityoftacoma.org/arcgis/rest/services/Locators/AddressStreetParcel/GeocodeServer/findAddressCandidates?Street=";
      url2 = String(address);
